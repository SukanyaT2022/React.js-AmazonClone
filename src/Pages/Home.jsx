        ...
        <div className="">
          ...
          <div className=" shadow4side main2side grid grid-cols-2 mt-5  p-3 h-[50%] relative lg:pt-5 md:py-5">
            <div>
              ...
              <button
                type="button"
                className="text-yellow-400 hover:text-white border border-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 absolute bottom-10 left-5"
              >
                Shop now
              </button>
            </div>
